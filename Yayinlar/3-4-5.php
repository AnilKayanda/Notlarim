...
<body>
    ...
    <div class="container_0">
        <img src="../img/456Yayinarlijpg.jpg" alt="">
        <h3>4-5-6 Yayınları Olarak Her Zaman Yanınızdayız</h3>
    </div>
        ...
        function showDetails(course, event) {
            ...
            switch (course) {
                case 'Matematik':
                    ...
                    <h3 class="h3">4-5-6 Yayınları TYT ${course} Ders Notları</h3>
                    <main>
    ...
    <form action="../sepet.php" method="post">
                        <input type="hidden" name="product_name" value="3-4-5 Yayınları ${course} Ders Notları">
                ...
                case 'Fizik':
                    content.innerHTML = `
                    <img src="../img/${course}.png" alt="">
                    <h3 class="h3">4-5-6 Yayınları AYT  ${course} Ders Notları</h3>
                    <main>
